...
public class LoopTest extends PluggableProcessEngineTestCase {

  @Deployment(resources = {"org/camunda/bpm/engine/cassandra/loop.bpmn"})
  public void test() {
    ...
    for (int i = 0; i < 2; i++) {
      runtimeService.createMessageCorrelation("continue")
        .processInstanceId(processInstance.getId())
        .correlateAll();
      if (i % 10 == 0) {
        logger.log(Level.SEVERE, "Iteration: " + i);
      }
    }
